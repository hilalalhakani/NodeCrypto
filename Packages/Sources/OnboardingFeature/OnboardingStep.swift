    ...
    public func value() -> Step {
        ...
        case .step1:
            return Step(
                ...
                imageName: ImageResource(name: "Onboarding1", bundle: .module),
        ...
        case .step2:
            return Step(
                ...
                imageName: ImageResource(name: "Onboarding2", bundle: .module),
        ...
        case .step3:
            return Step(
                ...
                imageName: ImageResource(name: "Onboarding3", bundle: .module),
        ...
        case .step4:
            return Step(
                ...
                imageName: ImageResource(name: "Onboarding4", bundle: .module),
                gradientColors: [Color.onboarding2Gradient1, Color.onboarding2Gradient2]
            )
        }
    }
